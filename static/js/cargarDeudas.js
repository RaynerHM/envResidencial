            ...
            success: function(data) {
                ...
                if (data.deuda.length > 0) {
                    ...
                    for (var i = 0; i < data.deuda.length; i++) {
                        $('#tbody').append(
                            ("<tr id='tr" + data.deuda[i].id + "'><td><p><label><input type='checkbox' class='micheckbox filled-in' id='" + data.deuda[i].id + "' value='" + data.deuda[i].id + "'/> <span id='s" + data.deuda[i].id + "'>Seleccionar</span><label></p></td><td>RD$" + data.deuda[i].deuda_pendiente + "</td><td>RD$" + data.deuda[i].recargo + "</td>" +
